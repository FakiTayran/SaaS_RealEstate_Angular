...
@Component({
  selector: 'app-forms',
  standalone: true,
  imports: [CommonModule, NgFor, NgIf, MatFormFieldModule, MatInputModule, FormsModule, ReactiveFormsModule, MatCheckboxModule, MatRadioModule, MatButtonModule, MatOption, MatSelect],
